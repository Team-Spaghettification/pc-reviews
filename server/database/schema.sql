...
CREATE TABLE products (
  ...
  fit             DECIMAL(10,9) DEFAULT NULL,
  width           DECIMAL(10,9) DEFAULT NULL,
  length          DECIMAL(10,9) DEFAULT NULL,
  comfort         DECIMAL(10,9) DEFAULT NULL,
  quality         DECIMAL(10,9) DEFAULT NULL,
  size             DECIMAL(10,9) DEFAULT NULL,
  PRIMARY KEY     (id)
);
